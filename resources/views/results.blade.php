...
<style>
    ...
    .table tr:nth-child(odd){ background-color:#419cf2; }
    ...
    .table tr:first-child td{
        background:-o-linear-gradient(bottom, #9400ff 5%, #0035bc 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #9400ff), color-stop(1, #0035bc) );
        background:-moz-linear-gradient( center top, #9400ff 5%, #0035bc 100% );
        filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#9400ff", endColorstr="#0035bc");	background: -o-linear-gradient(top,#9400ff,0035bc);
